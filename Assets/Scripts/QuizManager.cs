...
public class QuizManager : MonoBehaviour
{
    ...
    [SerializeField]
    private GameObject immediateResult;
    ...
    [SerializeField]
    private List<int> correctOptions = new List<int>();
    
    private static List<int> chosenOptions = new List<int>();
    ...
    {
        option.optionImage.color = new Color(0.1241f, 0.9607f, 0.7098f);
